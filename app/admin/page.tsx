            ...
            <tbody>
              {products.map((product) => (
                ...
                >
                  ...
                  <td className="max-w-[200px] px-4 py-3 align-middle font-medium text-gray-900">
                  ...
                  <td className="px-4 py-3 align-middle text-right">
                    <div className="inline-flex items-center justify-end gap-1">
                      ...
                      <button
                        type="button"
                        className="rounded-xl p-2 text-gray-500 transition-colors hover:bg-gray-100 hover:text-red-600"
                        aria-label="Удалить"
                      >
